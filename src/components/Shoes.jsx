...
function Shoes(props) {
  ...
  const colorMap =  useTexture(Store.pattern[snap.current])
  ...
  return (
    <group ref={ref} {...props} dispose={null}
      ...
      onPointerDown={(e) => { e.stopPropagation(); Store.current = e.object.material.name}}
    ...
    >
      ...
      <mesh geometry={nodes.shoe_1.geometry} material={materials.mesh} material-color={snap.color.mesh} material-map={colorMap} />
