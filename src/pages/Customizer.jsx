  ...
  useEffect(() => {
    ...
    return (
      <div className="wrapper">
        <div className="title">To design the {active} of the {title}</div>
        <div className="options">
          <div className="option" onClick={()=>{setActive('material');Store.current='body'}} style={{backgroundColor:active==='material'?'hotpink':'#8df1e7'}}>
          ...
          <div className="option" onClick={() =>{setActive('pattern');Store.current='body'}} style={{backgroundColor:active==='pattern'?'hotpink':'#8df1e7'}}>
          ...
          <div className="option" onClick={()=>setActive('color')} style={{backgroundColor:active==='color'?'hotpink':'#8df1e7'}}>
