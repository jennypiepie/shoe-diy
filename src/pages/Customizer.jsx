    ...
    return (
      <div className="wrapper">
        ...
        <div className="options">
          ...
          <div className="option" onClick={()=>setActive('pattern')} style={{backgroundColor:active==='pattern'?'hotpink':'#8df1e7'}}>
          ...
          <div className="option" onClick={()=>setActive('material')} style={{backgroundColor:active==='material'?'hotpink':'#8df1e7'}}>
            ...
            {Store[snap.current][active].map((item) => (
              ...
              <div className="selector-item"
                style={{ backgroundImage: `url(${item})`,backgroundSize: '100%,100%'}}
                  onClick={() => {
                    Store[active][snap.current] = item;
                    setRe(re + 1)
                  }}
                ></div>
                :
